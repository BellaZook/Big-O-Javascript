...
const ArraySearch = props => {
    return (
        <SubjectCard title="Array Search">
            ...
            <p>Starting on the left side of the array, search for "c" in stringArray: <br />
                stringArray.indexOf("c") = 2
            </p>
            <hr />
            <p>Starting on the right side of the array, search for "c" in stringArray:</p>
            <Alert color="warning">
            ...
            <p>
                Starting on the left side of the array, search for 12 in numberArray: <br />
